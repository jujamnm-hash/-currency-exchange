...
window.showIraqiBureausRates = showIraqiBureausRates;
window.showAdminRatesEditor = showAdminRatesEditor;
window.saveAdminRates = saveAdminRates;
window.resetToDefaults = resetToDefaults;
window.switchBureauTab = switchBureauTab;
window.fetchIraqiRates = fetchIraqiRates;
window.autoFillFromBureaus = autoFillFromBureaus;
window.exportBureauRates = exportBureauRates;
window.showBureauSettings = showBureauSettings;
window.toggleBureau = toggleBureau;
window.saveBureauSettings = saveBureauSettings;
